...
namespace CQC.ConTest
{
    public partial class ucProjectExplorer : System.Windows.Forms.UserControl
    {
        ...
        public event Action<TestClassModel> ExecuteTestClassEvent;
        public event Action<TestCaseModel> ExecuteTestCaseEvent;
            ...
            switch (ni.ntype)
            {
                ...
                case NodeType.dpdevice:
                    CreateDXMenuItem(e, "Create Device", hitInfo.Node,
                        new EventHandler(AddDeviceNode), fileTypeSvgImages.GetImage(40));
                    break;
